...
public class VideosListViewHolder extends BaseViewHolder<Video> {
    ...
    public VideosListViewHolder(View itemView, @NonNull VideoDescriptionManager descriptionManager) {
        super(itemView);
    ...
    @Override
    public void bindViewHolder(@NonNull Video video, int position) {
