...
public class VideosFragmentPresenter
        extends BaseFragmentPresenter<FragmentView<Video>, Video> {

    public VideosFragmentPresenter(@NonNull DataManager<Video> dataManager) {
        super(dataManager);
    }
    ...
    protected String getFirstLoadKey() {
        return CacheKey.VideosFragment.FIRST_VISIBLE;
    }

    @NonNull
    @Override
    protected String getDataKey() {
        return CacheKey.VideosFragment.ITEMS_DATA;
    }
}
